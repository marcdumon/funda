...
def make_interim_stockpup():
    ...
    # ticker_info = pd.read_csv(base_data_path + raw_yahoo_info_path + 'yahoo_info_raw_data.csv', index_col=0)
    ...
    cols = ['Ticker', 'Quarter start', 'Quarter end', 'Shares', 'Shares split adjusted', 'Split factor',
            ...
            # Ratio's
            'ROE', 'ROA', 'Book value of equity per share', 'P/B ratio', 'P/E ratio',
...
if __name__ == '__main__':
    ...
    # make_interim_data(start_from='MLM',end_till='Q', write_log=False)
    # make_interim_data(start_from='U',end_till='Z', write_log=False)
